          ...
          return (
            ...
            >
              ...
              >
                ...
                <h3 className={`mt-6 font-display text-2xl font-bold tracking-tight ${isCommercial ? "text-white" : "text-gray-900"}`}>{product.name}</h3>
                <p className={`mt-3 flex-1 text-sm leading-7 ${isCommercial ? "text-white/60" : "text-gray-500"}`}>{product.description}</p>
