...
export function TrustBar() {
  return (
    <section className="relative overflow-hidden border-y border-black/20 bg-[linear-gradient(90deg,#001033_0%,#001a4d_20%,#00307a_50%,#001a4d_80%,#001033_100%)] py-10">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-20 gap-y-6 px-4 sm:px-6 lg:justify-center lg:gap-x-32 lg:px-8">
