 ...
 *
 * Presets: "light" | "medium" | "heavy" | "soft" | "rigid" | "selection"
 *        | "nudge" | "success" | "warning" | "error" | "buzz"
 *
 * Defaults to "selection" — the lightest tap, suitable for buttons/links.
 */
...
/** Convenience aliases matching common UI interactions. */
