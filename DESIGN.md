...
No Magic UI, Mobbin, Figma, or external component primitive is used here: faithful adaptation of the supplied campaign is the approved direction, and decorative library components would add drift.
...
```json
{
  ...
  "motion": "rise-in hierarchy reveal; 150-280ms interaction transitions; reduced-motion disables animation",
