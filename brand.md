...
- **Latest campaign phone direction (2026-08-25):** Erin and Frank clarified that the website should use one phone number only, `(866) 688-6145`, as the Google landing-page tracking number. Meta uses click-to-call directly in the ads and does not use the website's phone CTA. Do not restore client-side CallRail number swapping on this route without new written approval.
